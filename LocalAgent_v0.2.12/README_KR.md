# VisionQC Local Agent v1.0.0

## v1.0.0 오프라인 패키지
- `VisionQC_Agent_Installer_v1.0.0.exe` 하나로 Agent 설치, `visionqc-agent://` 프로토콜 등록, Agent 실행, 오프라인 UI 열기를 처리합니다.
...
6. `http://127.0.0.1:17891/api/status`에서 `agentVersion: 1.0.0` 확인
