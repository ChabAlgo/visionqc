...
& $compiler /nologo /langversion:7.3 /target:exe /r:System.Drawing.dll ("/out:$target") (Join-Path $PSScriptRoot '..\Services\ResultCsv.cs') (Join-Path $PSScriptRoot '..\Services\PartitionedCsvWriter.cs') (Join-Path $PSScriptRoot '..\Services\WorkspaceIdentity.cs') (Join-Path $PSScriptRoot '..\Services\OverlayGeometry.cs') (Join-Path $PSScriptRoot 'fixtures\DataIntegrityTests.cs')
