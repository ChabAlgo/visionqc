(() => {
  ...
  const EXPECTED_AGENT_VERSION = '1.3.12';
  const AGENT_INSTALLER_URL = './downloads/VisionQC_Agent_Installer_v1.3.12.exe';
  const OFFLINE_PACKAGE_URL = './downloads/VisionQC_Offline_v4.7.22.zip';
