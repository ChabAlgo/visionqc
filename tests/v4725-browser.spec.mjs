...
test('history DB delete requires confirmation and refreshes the empty database',async({page})=>{
 ...
 await page.route('**/api/status',route=>route.fulfill({status:200,contentType:'application/json',body:JSON.stringify({ok:true,agentVersion:'1.4.1',vpdlAvailable:true,running:false})}));
