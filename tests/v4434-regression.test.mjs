...
test('v4.7.15 assets and the supplied TOPTEC logo are exact', () => {
  assert.match(html, /VisionQC DirectExport v4\.7\.15/);
  assert.match(html, /assets\/index-v4\.4\.33\.js/);
  assert.match(html, /visionqc-v4433-clean\.css\?v=4\.7\.15/);
  assert.match(html, /visionqc-extension\.js\?v=4\.7\.15/);  assert.ok(existsSync(resolve(root, 'assets/index-v4.4.33.js')));
