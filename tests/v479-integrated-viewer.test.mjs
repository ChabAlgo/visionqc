...
test('v4.7.16 preserves Integrated Crop images for Viewer and makes light Simulation state identifiable', () => {
  assert.match(web, /const VERSION = '4\.7\.16'/);  assert.match(web, /keepCropImages:true/);
