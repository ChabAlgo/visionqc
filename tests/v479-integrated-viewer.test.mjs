...
test('v4.7.11 preserves Integrated Crop images for Viewer and makes light Simulation state identifiable', () => {
  assert.match(web, /const VERSION = '4\.7\.11'/);  assert.match(web, /keepCropImages:true/);
