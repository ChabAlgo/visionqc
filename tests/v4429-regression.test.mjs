...
const css = read('visionqc-v4429-clean.css');

test('v4.4.29 assets and the supplied TOPTEC logo are exact', () => {
  assert.match(html, /VisionQC DirectExport v4\.4\.29/);
  assert.match(html, /assets\/index-v4\.4\.29\.js/);
  assert.match(html, /visionqc-v4429-clean\.css\?v=4\.4\.29/);
  assert.match(html, /visionqc-extension\.js\?v=4\.4\.29/);
  assert.ok(existsSync(resolve(root, 'assets/index-v4.4.29.js')));
