# VisionQC Local Agent API - v0.2.2
...
## Custom Position
Web v4.4.22은 Tool마다 `positionKeys` 배열을 보냅니다. Agent v0.2.2은 기존 CA_TOP/AN_TOP/CA_BOT/AN_BOT boolean과의 하위 호환을 유지하면서 `positionKeys`가 있으면 그것을 우선 사용합니다.

## POST /api/workspace/inspect
Runtime Workspace를 로드해 Stream/Tool 구조를 조회합니다. ToolType, Green KnownTags, Red KnownClasses, Blue KnownFeatures를 반환합니다.
